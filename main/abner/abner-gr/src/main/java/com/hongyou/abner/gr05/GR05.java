    ...
    public ResponseEntry save(@RequestBody final PaymentPojo pojo) {
        ...
        try {
            ...
            for (PylinePojo line : pojo.getMaterials()) {
                ...
                paymentAmount = paymentAmount.add(pyline.getPayamt());
            ...
            if (BigDecimal.ZERO.compareTo(pyhead.getPayamt()) == 0) {
                pyhead.payamt(paymentAmount);
            }
            ...
            pohead.paycnt(pohead.getPaycnt() + 1).
                    ...
                    paysts(finished ? Pohead.PAYSTS.Finished : Pohead.PAYSTS.Part).
                    oprtby(operatorBy).
                    oprttm(currentTime);
