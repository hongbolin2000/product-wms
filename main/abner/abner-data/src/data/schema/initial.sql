...
insert into pmsnms(cmpnid, sortng, pmsncd, remark, actcde, actnam) values (1, 1, 'gr09', '生产记录管理', 'browse', '查看');
insert into pmsnms(cmpnid, sortng, pmsncd, remark, actcde, actnam) values (1, 2, 'gr09', '生产记录管理', 'add', '生产录入');
insert into pmsnms(cmpnid, sortng, pmsncd, remark, actcde, actnam) values (1, 4, 'gr09', '生产记录管理', 'delete', '删除');
...
insert into pmsnms(cmpnid, sortng, pmsncd, remark, actcde, actnam) values (1, 1, 'wr02', '库存明细报表', 'update', '库存调整');
